...
public class FmEventDtoClearTimeAscComparator implements Comparator<FmEventVO> ,Serializable
{
	...
	{
		int clearTimeCompVal = FmUtil.getClearTimeCompVal( o1.getClearTime() , o2.getClearTime());
