...
public class FmEventDtoNeIdDescComparator implements Comparator<FmEventVO> ,Serializable
{
	...
	{
		int neIdComVal = FmUtil.getNeIdIntValue( o2.getNeId()) - FmUtil.getNeIdIntValue( o1.getNeId());
		if(  neIdComVal == 0 )
		{
