...
!function e(t, n, i) {
    ...
    2: [function(e, t, n) {
        ...
        function i(e, t) {
            ...
            var o;
            return e.nodeName ? "img" !== e.nodeName.toLowerCase() ? t(new Error("Element supplied is not an image")) : e.src && e.complete && void 0 !== e.naturalWidth ? t(null, !0) : (n(e, "load", !0, i),
            n(e, "error", !0, i),
            void ((e.readyState || e.complete) && (o = e.src,
            e.src = r,
            e.src = o))) : t(new Error("First argument must be an image element"))
        }
        ...
        var i = e("./Image.js")
          , r = {
            getImageSrcs: function(e) {
                if (this.sources = [],
                "undefined" != typeof e && (this.findImageInElement(e),
                this.deepSearch === !0))
                    for (var t = e.querySelectorAll("*"), n = 0; n < t.length; n++)
                        "SCRIPT" !== t[n].tagName && this.findImageInElement(t[n]);
                return this.sources.length || this.sources.push("data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"),
                this.sources
            },
            ...
            determineUrlAndType: function(e) {
                ...
                return "undefined" != typeof i.backgroundImage && "" !== i.backgroundImage && "none" !== i.backgroundImage || "undefined" != typeof e.style.backgroundImage && "" !== e.style.backgroundImage && "none" !== e.style.backgroundImage ? (t = i.backgroundImage || e.style.backgroundImage,
                n = "background") : "img" === e.nodeName.toLowerCase() && (t = e.src),
                {
                    url: t,
                    type: n
                }
        ...
        var i = e("./PercentageParser")
          , r = {
            ...
            updateProgress: function(e, t) {
                ...
                e = i(e),
                this.element.style.width = e*0.6 + "%" //jini
            },
        ...
        var i = e("./LoadingBar")
          ...
          , o = {
            init: function() {
                ...
                this.showPercentage && (this.percentage = r(),
                ...
                this.progressBg.setAttribute("id", "progressBg"),
                this.element.appendChild(this.progressBg);
                
                this.appendDiv = document.createElement("div"),
                this.appendDiv.setAttribute("id", "loadingDivCls"),
                this.element.appendChild(this.appendDiv)
            	this.appendImg = document.createElement("IMG"),
                this.appendImg.setAttribute("id", "loadingImg"),
                this.appendImg.setAttribute("src", "dist/img/itam_loding.png"),
                /* this.appendDiv.append(this.appendImg);*/
                this.appendDiv.appendChild(this.appendImg);    
            },         
            create: function() {
        ...
        var i = e("./../ImagePreloader")
          ...
          , o = {
            init: function(e, t) {
                ...
                "undefined" != typeof this.element && (this.createOverlay(),
            ...
            updateProgress: function(e, t) {
                ...
                e === t && this.done === !1 && (window.clearTimeout(this.maxTimeout),
