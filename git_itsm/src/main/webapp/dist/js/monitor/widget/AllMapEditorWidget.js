define([
    ...
    "underscore",
    "backbone",
    "text!views/monitor/allMapEditorWidget",
    "css!cs/monitor/allMapEditorWidget",
    "w2ui"
],function(
    $,
    _,
	...
	function mapEditorListTypeWidget(id) {
		this.selector = $("#"+id);
		_this = this;
	...
	mapEditorListTypeWidget.prototype = {
		init : function() {
			console.log("All Map Editor Custom Widget Init");
		...
		render : function() {
			...
			let mapListId = "allList" + sessionStorage.GROUP_ID + "-"+sessionStorage.PRIVILEGE_ID;
			let mapListDiv = '<div id="'+mapListId+'" class="yesMap" type="list"></div>'
			let mapId = "allMap" + sessionStorage.GROUP_ID + "-"+sessionStorage.PRIVILEGE_ID;
			let mapDiv = '<div id="'+mapId+'" class="yesMap" type="map"></div>'
			
			$(".allMapEditorWidget #mapEditorListType").append(mapListDiv);
			$(".allMapEditorWidget #mapEditor").append(mapDiv);
...
//        		param : selectItem,
    ...
    return mapEditorListTypeWidget;
});