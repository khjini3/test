...
<html>
	...
	<body id="captureScreen" class="hold-transition skin-blue layout-top-nav">
				...
				<div class="container">
					...
					<div class="navbar-custom-menu">
						...
						<div class="noselect" style="float:left;position:relative;top:11px; right:7px; width:28px;">
							<i class="fab fa-yes-connection fa-2x noselect" id="connectStatus" title="Connection" style="color:#64ff4f; cursor:default; padding:4px;"></i>
							<i class="fab fa-yes-disconnection fa-2x noselect" id="connectStatus" title="Disconnection" style="color:#737373; cursor:default; padding:4px;"></i>
		...
		<div class='content'>
			<div class='content-title'><div style="float:left;width:230px;"><span class="noselect"></span></div>
